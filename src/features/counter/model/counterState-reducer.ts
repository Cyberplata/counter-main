...
// }
//
// export const resetCounterAC = (payload: { countUser: number; setButtonDisabled: boolean }) => {
//    return {
//       type: "RESET_COUNTER",
//       payload,
//    } as const
...
export type CounterStateReducerActionsType = setCountUserActionType | setMaxValueActionType | setStartValueActionType
// | setErrorActionType
