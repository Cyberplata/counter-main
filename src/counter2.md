...
4. [] Переписать логику приложения, то есть в Редьюсере оставить только 3 свойства countUser: 0, maxValue: 5, startValue: 0, а остальные оставить в useState
5. [] // SaveToLocalStorage(); закомментировал